...
/***/ function(module, exports, __webpack_require__) {
	...
	var _src = __webpack_require__(246);
	...
	var REDAL_REF = (0, _symbol2.default)('redal');
	...
	var Demo = function (_Component) {
	  ...
	  function Demo(props, context) {
	    ...
	    var _this = (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(Demo).call(this, props, context));

	    _this.state = { scoped: false, maskToggle: false, hasMaskClickHandler: true };
	    return _this;
	  }
	  ...
	  (0, _createClass3.default)(Demo, [{
	    ...
	    value: function render() {
	      ...
	      var scoped = _state.scoped;
	      var maskToggle = _state.maskToggle;
	      var hasMaskClickHandler = _state.hasMaskClickHandler;

	      var maskClickHandler = hasMaskClickHandler ? function () {
	        return confirm('close on mask clicked?');
	      } : null;
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          { onClick: function onClick() {
	              return _this2.refs[REDAL_REF].toggle(false);
	            } },
	          'Open Redal'
	        ),
	        _react2.default.createElement(
	          'button',
	          { onClick: function onClick() {
	              return _this2.setState({ scoped: !scoped });
	            } },
	          'scoped: ',
	          scoped ? 'true' : 'false'
	        ),
	        _react2.default.createElement(
	          ...
	          'maskToggle: ',
	          maskToggle ? 'true' : 'false'
	        ),
	        _react2.default.createElement(
	          'button',
	          { onClick: function onClick() {
	              var shouldDisableToggle = maskToggle && !hasMaskClickHandler;
	          ...
	          'hasMaskClickHandler: ',
	          hasMaskClickHandler ? 'true' : 'false'
	        ),
	        _react2.default.createElement(
	          'div',
	          { className: 'scope' },
	          _react2.default.createElement(
	            _src2.default,
	            {
	              ...
	              beforeEnter: function beforeEnter() {
	                return _this2.setState({ msg: '' });
	              },
	              didEnter: function didEnter() {
	                _this2.setState({ msg: 'did enter' });
	                alert('did enter');
	              },
	              didLeave: function didLeave() {
	                _this2.setState({ msg: 'did leave' });
	                alert('did leave');
	              }
	            },
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                _src2.default.X,
	                { component: 'h3', beforeLeave: function beforeLeave() {
	                    return confirm('confirm leave?');
	                  } },
	                ' close redal '
	              )
	            )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactAddonsTransitionGroup = __webpack_require__(253);

	var _reactAddonsTransitionGroup2 = _interopRequireDefault(_reactAddonsTransitionGroup);

	var _wrapper = __webpack_require__(256);

	var _wrapper2 = _interopRequireDefault(_wrapper);

	var _x3 = __webpack_require__(261);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _domContains = __webpack_require__(259);

	var _domContains2 = _interopRequireDefault(_domContains);

	var _linkFuncs = __webpack_require__(260);
